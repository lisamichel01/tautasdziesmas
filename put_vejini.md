...
original: |  
  ...
  Pats precēju līgavīņu,  	
  <span class="tooltip">Tēvam, mātei nezinot<span class="tooltiptext">Bei dieser Konstruktion handelt es sich um einen Dativus Absolutus. Im Alltag wird man einer solchen praktisch nicht begegnen. Alternativ lautet diese Zeile auch "Tēvs, māmiņa nezina".</span></span>.    	
uebersetzung: |  
  Wehe, Wind, treibe mein Schiff,  
  Treibe mich fort nach Kurland.   
  ...
  Einen, der Pferde hetzt.  

  Welches Wirtshaus habe ich leergetrunken,  
  Wessen Pferd zu Schanden geritten?  

  Für mein eigenes Geld habe ich getrunken,  
  Mein eigenes Pferd gehetzt.  

  Meine Braut habe ich selbst genommen,  
  Ohne dass Vater und Mutter es wussten.   

video: https://www.youtube.com/embed/ido3HgdiIzU?si=m-njzWLEr7e-GaxP
---